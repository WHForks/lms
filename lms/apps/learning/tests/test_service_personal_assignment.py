...
from courses.tests.factories import AssignmentFactory, CourseFactory, CourseTeacherFactory, CourseProgramBindingFactory
...
def test_resolve_assignees_for_personal_assignment(settings, program_cub001, program_run_cub):
    ...
    student_assignment = StudentAssignmentFactory(
        ...
        assignee=None,
        student__student_profile__academic_program_enrollment=program_run_cub
    )
    # Disabled mode
    ...
    student_profile = get_student_profile(user=student_assignment.student)
