...
function courseOfferingsList() {
  ...
  yearsFilter.on('change', 'select[name="academic_year"]', eventData, filterCourseOfferings);
  termsFilter.on('click', 'a', eventData, filterTermAction);
  // Tooltips
  $(wrapper).tooltip({
  ...
  window.onpopstate = function (event) {
    ...
    updateDOM(eventData, filterState.termSlug, filterState.academicYear, filterState.selectedTerm);
  };
}
